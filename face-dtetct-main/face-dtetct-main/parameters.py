...
# Default is relative to project, but you can override with an environment
# variable (e.g. set DATASET_PATH to the folder containing student subdirs).
DATASET_PATH = os.environ.get('DATASET_PATH', r'C:/Users/Apurava Raj/OneDrive/Grill/Grill Assignment/Student Images/')

# The path where dlib face encodings are stored
DLIB_FACE_ENCODING_PATH = 'data/gril_team_face_encodings.pkl'  # created by dlib_face_embeddings.py
